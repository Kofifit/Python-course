...
host = re.findall(r'(\d+\.\d+\.\d+\.\d+)', logdata)
user_name = re.findall(r'- (\S+)', logdata)
time = re.findall(r'\[([^\]]*)', logdata)
request = re.findall(r'\"([^\"]*)\"', logdata)
print(len(host))
print(len(user_name))
print(len(time))
print(len(request))
for i in range(0,len(host)):
    ...
    tempDict = dict()
    tempDict['host'] = host[i]
    tempDict['user_name'] = user_name[i]
    tempDict['time'] = time[i]
    tempDict['request'] = request[i]
